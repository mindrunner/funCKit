...
/**
 * Creates a SimulationValidator with four checks: TwoInputsConnectedCheck,
 * TwoOutputsConnectedCheck, MultipleWiresOnInputCheck and ZeroDelayLoopCheck.
 */
public class SimulationValidatorFactory extends AbstractValidatorFactory {

    /**
     * Creates a new {@link SimulationValidatorFactory}.
     */
    public SimulationValidatorFactory() {
