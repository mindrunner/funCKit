 ...
 */
public class InputImpl extends AccessPointImpl implements Input {

    /**
     * Create a new InputImpl.
     * 
     * @param brick
     ...
     */
    public InputImpl(Brick brick, Point position, String name) {
    ...
    public String toString() {
        ...
        stringBuilder.append("Element: Input, ");
