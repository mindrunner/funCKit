...
/**
 * Listener for changes on a {@link EditPanelScrollPane}s horizontal scrollbars
 * {@link BoundedRangeModel}.
 */
public class EditPanelScrollPaneHorizontalScrollbarBoundedRangeModelChangeListener
     ...
     */
    public EditPanelScrollPaneHorizontalScrollbarBoundedRangeModelChangeListener(
    ...
    public void stateChanged(ChangeEvent event) {
        ...
        int newX = sbModel.getValue();
        // int y = transformedPos.y;
        editPanel.getPanelModel().translate(newX - transformedPos.x, 0);
    }
