...
/**
 * Listener object to close a project.
 */
public class TreeCloseProjectActionListener extends AbstractAction {

    private static final long serialVersionUID = 8825109259138577239L;
     ...
     *            project to remove
     */
    public TreeCloseProjectActionListener(View view, Controller controller,
            Project project) {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        while (project.getOpenedEditPanelModels().size() != 0) {
            project.removeEditPanelModel(project.getOpenedEditPanelModels()
                    .iterator().next());
        }
        project.setCircuit(null);
