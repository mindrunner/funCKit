...
/**
 * Listener that reacts on zoom out requests from the view.
 * 
 */
public class ZoomOutActionListener extends AbstractAction {

    private static final long serialVersionUID = -2273016329709252454L;
     ...
     */
    public ZoomOutActionListener(View view, Controller controller) {
