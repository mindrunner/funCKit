...
/**
 * Listener object for events indicating the wish to exit the application.
 */
public class ExitApplicationActionListener extends AbstractAction {

    private static final long serialVersionUID = 1724521644150689831L;
     ...
     */
    public ExitApplicationActionListener(View view, Controller controller) {
        this.controller = controller;
    }

    @Override
    public void actionPerformed(ActionEvent arg0) {
        controller.getSessionModel().prepareExit();
    }
