...
/**
 * This class contains the methods to export JPG-Pictures.
 */
public class JPGExporter extends PixelImageExporter {

    /**
     * Creates a new JPGExporter.
     * 
     * @param settings
     *            The current settings object
     */
    public JPGExporter(Settings settings) {
        super(settings);
    }
