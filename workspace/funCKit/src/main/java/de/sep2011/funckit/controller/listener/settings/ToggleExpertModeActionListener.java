...
public class ToggleExpertModeActionListener extends AbstractAction {
     ...
     */
    public ToggleExpertModeActionListener(View view, Controller controller) {
        this.view = view;
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        boolean old = settings.getBoolean(Settings.EXPERT_MODE);
        settings.set(Settings.EXPERT_MODE, !old);
        Log.gl().info("Expert mode: " + settings.getBoolean(Settings.EXPERT_MODE));
        view.rebuildView();
    }
