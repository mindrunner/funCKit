...
/**
 * This Listener is notified on events indicating a request to start the
 * simulation.
 */
public class SimulationStopButtonListener extends AbstractAction {

    private static final long serialVersionUID = 2167122794863916616L;
     ...
     */
    public SimulationStopButtonListener(View view, Controller controller) {
        this.controller = controller;
    }

    @Override
    public void actionPerformed(ActionEvent event) {
        // view.getSimulationTimer().stop();
        ...
        if (project != null) {
            ...
            EditPanelModel panelModel = project.getSelectedEditPanelModel();
            controller.enterEditMode(panelModel != null
                    && panelModel.hasMainCircuit());
        }
    }
