...
/**
 * Action performed when grid should be toggled on or off.
 */
public class GridOnOffActionListener extends AbstractAction {

    private static final long serialVersionUID = 5343011094988033963L;
     ...
     */
    public GridOnOffActionListener(View view, Controller controller) {
        this.view = view;
    }
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        Boolean current = settings.getBoolean(Settings.SHOW_GRID);
        settings.set(Settings.SHOW_GRID, !current);
    }
