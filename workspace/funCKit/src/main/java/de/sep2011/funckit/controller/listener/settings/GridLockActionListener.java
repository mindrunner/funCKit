...
/**
 * Listener that reacts to grid lock toggle event. 
 */
public class GridLockActionListener extends AbstractAction {

    private static final long serialVersionUID = 1916784976943009324L;
     ...
     */
    public GridLockActionListener(View view, Controller controller) {
        this.view = view;
    }
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        Boolean current = settings.getBoolean(Settings.GRID_LOCK);
        settings.set(Settings.GRID_LOCK, !current);
    }
