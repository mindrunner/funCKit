 ...
 * run slower.
 */
public class SimulationSlowerButtonListener extends AbstractAction {

    private static final long serialVersionUID = 5128235198955816338L;

    private static final double SIMULATION_DECELERATION = 2;
     ...
     */
    public SimulationSlowerButtonListener(View view, Controller controller) {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (project != null) {
            project.setTimerDelay((int) (project.getTimerDelay() * SIMULATION_DECELERATION));
            Log.gl().debug("Timer Delay: " + project.getTimerDelay());
        }
