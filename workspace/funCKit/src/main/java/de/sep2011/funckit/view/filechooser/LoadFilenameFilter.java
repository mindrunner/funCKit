...
/**
 * Filenamefilter that combines all loadable file formats (funCKit, SEP, ComponentType).
 */
class LoadFilenameFilter implements FilenameFilter {
    ...
    public boolean accept(File dir, String name) {
        return funckitFormat.accept(dir, name) || sepFormat.accept(dir, name) || cmpFormat.accept(dir ,name);
    }
