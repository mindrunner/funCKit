...
/**
 * Exception thrown when something goes wrong while importing.
 */
public class ImportException extends Exception {
     ...
     * 
     */
    private static final long serialVersionUID = -8991989555117632846L;
     ...
     */
    protected ImportException(Throwable cause) {
        super(cause);
    }
