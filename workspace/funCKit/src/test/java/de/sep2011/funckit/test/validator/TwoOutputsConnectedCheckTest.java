...
/**
 * this class contains tests for {@link TwoOutputsConnectedCheck}.
 */
public class TwoOutputsConnectedCheckTest {

    /**
     * Creates a Circuit with two {@link Output}s connected and checks if the
     * Check detects this and gives the correct flawElements.
     */
    @Test
    public void testTwoOutputsConnectedCheckTest() {
        ...
        Check ch1 = new TwoOutputsConnectedCheck();
        ...
        // check results
        for (Brick b : cf1.getConnectedOutputBricks()) {
            assertTrue(r1.getFlawElements().contains(b));
        }

        Check ch2 = new TwoOutputsConnectedCheck();
