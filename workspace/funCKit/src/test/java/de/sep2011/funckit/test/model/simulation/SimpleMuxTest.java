...
/**
 * This test runs the simulation on simple Multiplexer which is a Component,
 * using all available input combinations, see /simpleMuxTest/testMux.fck in
 * resources..
 */
public class SimpleMuxTest {
    ...
    public void test() throws SEPFormatImportException {
        ...
        CircuitSimulator combTester = new CircuitSimulator(circuit, switches,
                lights);
        combTester.addTestRow("0 0 0", "0");
        combTester.addTestRow("1 0 0", "1");
        combTester.addTestRow("0 1 0", "0");
        combTester.addTestRow("1 1 0", "1");
        combTester.addTestRow("0 0 1", "0");
        combTester.addTestRow("1 0 1", "0");
        combTester.addTestRow("0 1 1", "1");
        combTester.addTestRow("1 1 1", "1");
