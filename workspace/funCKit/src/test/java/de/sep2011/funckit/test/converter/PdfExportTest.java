...
/**
 * This class tests the {@link PDFExporter} by exporting various Circuits. This
...
public class PdfExportTest {
    ...
    private void testCircuit(Circuit circuit, String name)
        ...
        PDFExporter pdfExporter = new PDFExporter(settings);
        pdfFile = new File(path + ".pdf");
        pdfExporter.doExport(circuit, new FileOutputStream(pdfFile));
        Assert.assertTrue(pdfFile.length() > 0L);
    }
